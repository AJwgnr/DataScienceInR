...
This project amins to study and analysis a data set using R and interactive visualize the results to allow scientits to explore the data set on thir onw.
