...
In the following two sections we describe our experiences with the R programming language and the Shiny package.
...
* No really clear requirements for the final project (maybe offer an example of how a final project should look like)
