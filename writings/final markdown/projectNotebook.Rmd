...
The id and name of the room both identify the room but can occur multiple time in the geometry file to form non rectangular rooms.
...
The data.table roomGraphData and roomHistData are stored similar to the trajectory data in two lists, one for each day. Following their structure:
